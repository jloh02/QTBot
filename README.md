...
Personally developed bot to remind people to do their quiet time in our CG
...
```
git clone https://github.com/jloh02/qt-bot
```
...
Instead of a DB, we opted for a local JSON file to allow for ease of deployment and logetivity of the project as this project will be managed at an individual basis